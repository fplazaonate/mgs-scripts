...
def parse_motus_file(motus_file):
    ...
    with open(motus_file, 'r') as istream:
        for line in istream:
            gene_name, motu_name = line.split()
...
def write_clusters_motus(output_dir, cluster_to_genes, cluster_motus, all_motus,  min_cluster_size):
...
def main():
    ...
    cluster_to_genes = parse_clusters_file(parameters.clusters_file)
    ...
    write_clusters_motus(parameters.output_dir, cluster_to_genes, cluster_motus, all_motus, parameters.min_cluster_size)
